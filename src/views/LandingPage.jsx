...
const stats = [
  { value: '87%', label: 'Churn prediction accuracy', color: 'text-accent-cobalt' },
  { value: '+26pts', label: 'Signal lift over behavioral-only', color: 'text-accent-amber' },
  { value: '₦42.3M', label: 'Estimated revenue protected', color: 'text-risk-low' },
  { value: '3 min', label: 'Average agent response time', color: 'text-accent-violet' },
]
  ...
  return (
    <div className="min-h-screen bg-bg-base text-text-primary overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="bg-accent-cobalt hover:brightness-110 active:scale-95 text-white font-plex font-semibold text-sm px-4 py-2 rounded-lg transition-all">
              Get Started
            </button>
          </div>
        </div>
      ...
      <section className="pt-32 pb-24 px-6 relative overflow-hidden">
        {/* Background glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] rounded-full bg-accent-cobalt opacity-[0.04] blur-[120px] pointer-events-none" />
        <div className="absolute top-20 right-1/4 w-[400px] h-[400px] rounded-full bg-accent-violet opacity-[0.04] blur-[100px] pointer-events-none" />

        <div className="max-w-4xl mx-auto text-center relative">
          <motion.div custom={0} variants={fadeUp} initial="hidden" animate="show">
            <span className="inline-flex items-center gap-2 font-mono text-[10px] text-accent-amber border border-accent-amber/30 bg-accent-amber-dim px-3 py-1.5 rounded-full tracking-widest mb-6">
          ...
          <motion.h1
            ...
            <span className="text-accent-cobalt">Retention Opportunity</span>
          </motion.h1>
          ...
          <motion.div
            ...
            <button
              onClick={() => navigate('/signup')}
              className="inline-flex items-center gap-2 bg-accent-cobalt hover:brightness-110 active:scale-95 text-white font-plex font-semibold text-base px-6 py-3 rounded-xl transition-all">
              Start Free Demo <ArrowRight size={18} />
            </button>
            <button
              onClick={() => navigate('/signin')}
              className="inline-flex items-center gap-2 border border-border-active text-accent-cobalt hover:bg-accent-cobalt-dim font-plex font-semibold text-base px-6 py-3 rounded-xl transition-all">
            ...
            <div className="p-4 grid gap-3" style={{ gridTemplateColumns: '2fr 1.5fr 1fr' }}>
              ...
              <div className="flex flex-col gap-2">
                <div className="bg-bg-elevated border border-border-default rounded-xl p-3 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-accent-cobalt to-accent-violet flex items-center justify-center text-white font-grotesk font-bold text-sm">CO</div>
                  <div>
                    <div className="font-grotesk font-semibold text-sm text-text-primary">Chioma Okonkwo</div>
                    <div className="font-mono text-[9px] text-accent-cobalt">00:47 · LIVE</div>
                  </div>
                </div>
                <div className="bg-bg-base border border-border-default rounded-xl p-3 space-y-1.5">
                  <div className="font-mono text-[8px] text-accent-amber tracking-widest">LIVE TRANSCRIPT — PIDGIN NLP ACTIVE</div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="bg-bg-elevated border border-border-default rounded-xl p-3 flex-1">
                  ...
                  {[['Port intent', 100, '#F87171'], ['Repeat contact', 77, '#F87171'], ['No recharge', 61, '#4F7EFF'], ['Competitor', 55, '#F5C518']].map(([label, w, color]) => (
              ...
              <div className="bg-bg-elevated border border-border-default rounded-xl p-3 flex flex-col gap-2">
                ...
                <div className="font-grotesk font-bold text-accent-amber text-sm">₦2,400/mo</div>
                <div className="font-mono text-[8px] bg-[rgba(52,211,153,0.15)] text-risk-low px-1.5 py-0.5 rounded w-fit">HIGH VALUE</div>
                <div className="mt-auto">
                  ...
                  <div className="mt-2 bg-accent-cobalt text-white font-plex text-[10px] font-semibold px-2 py-1 rounded text-center">Apply Offer</div>
                </div>
              </div>
            </div>
          </div>
          {/* Glow under preview */}
          <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-3/4 h-16 bg-accent-cobalt opacity-10 blur-2xl rounded-full pointer-events-none" />
        </motion.div>
      </section>
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <motion.div custom={0} variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-center mb-14">
            <span className="font-mono text-[10px] text-accent-cobalt tracking-widest uppercase">Platform Capabilities</span>
      ...
      <section id="how-it-works" className="py-24 px-6 bg-bg-surface border-y border-border-default">
        <div className="max-w-4xl mx-auto">
          <motion.div custom={0} variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-center mb-14">
            <span className="font-mono text-[10px] text-accent-amber tracking-widest uppercase">The Narrative</span>
            <h2 className="font-grotesk font-bold text-3xl text-text-primary mt-3">Signal → Score → Explanation → Action</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              { step: '01', icon: Mic, color: 'text-accent-cobalt', bg: 'bg-accent-cobalt-dim', title: 'Signal Detected', desc: 'Pidgin NLP picks up "wan port go Airtel" in real time' },
              { step: '02', icon: TrendingUp, color: 'text-risk-critical', bg: 'bg-[rgba(248,113,113,0.12)]', title: 'Score Updated', desc: 'Churn risk jumps from 61% to 87% — +26pt delta' },
              { step: '03', icon: BarChart2, color: 'text-accent-amber', bg: 'bg-accent-amber-dim', title: 'SHAP Explained', desc: 'Port intent contributes +0.31 to the prediction' },
              { step: '04', icon: ShieldCheck, color: 'text-risk-low', bg: 'bg-[rgba(52,211,153,0.12)]', title: 'Action Taken', desc: 'Agent applies 1GB bundle + loyalty offer in one click' },
            ].map((item, i) => (
              <motion.div key={i} custom={i} variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}
      ...
      <section id="results" className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          <motion.div custom={0} variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-center mb-12">
            <span className="font-mono text-[10px] text-risk-low tracking-widest uppercase">From the Field</span>
      ...
      <section className="py-24 px-6 bg-bg-surface border-t border-border-default">
        <motion.div custom={0} variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}
          ...
          <div className="w-14 h-14 rounded-2xl bg-accent-cobalt mx-auto flex items-center justify-center mb-6">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <button
              onClick={() => navigate('/signup')}
              className="inline-flex items-center gap-2 bg-accent-cobalt hover:brightness-110 active:scale-95 text-white font-plex font-semibold text-base px-8 py-3 rounded-xl transition-all">
      ...
      <footer className="border-t border-border-default px-6 py-8">
        <div className="max-w-6xl mx-auto flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded bg-accent-cobalt flex items-center justify-center">
